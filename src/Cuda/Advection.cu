...
void advect_f(HNS::GridIndexedData& data, const nanovdb::GridHandle<nanovdb::cuda::DeviceBuffer>& handle, const float dt,
...
void advect_v(HNS::GridIndexedData& data, const nanovdb::GridHandle<nanovdb::cuda::DeviceBuffer>& handle, const float dt,
...
extern "C" void AdvectScalar(HNS::GridIndexedData& data, const nanovdb::GridHandle<nanovdb::cuda::DeviceBuffer>& handle, const float dt,
                             const float voxelSize, const cudaStream_t& stream) {
	advect_f(data, handle, dt, voxelSize, stream);
}

extern "C" void AdvectVel(HNS::GridIndexedData& data, const nanovdb::GridHandle<nanovdb::cuda::DeviceBuffer>& handle, const float dt,
                          const float voxelSize, const cudaStream_t& stream) {
	advect_v(data, handle, dt, voxelSize, stream);
}